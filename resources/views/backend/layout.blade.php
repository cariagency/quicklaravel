...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="{{ assetv('css/backend.css') }}">
        @show
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="main-menu">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item {{ Request::is('admin/carousels*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('carousels.index') }}"><i class="fa fa-picture-o"></i> @lang("Carrousel")</a>
                    </li>
                    @if(isAdmin())
                    <li class="nav-item {{ Request::is('admin/users*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('users.index') }}"><i class="fa fa-users"></i> @lang("Users")</a>
                    </li>
                    @endif
                    @endauth
                </ul>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item {{ Request::is('admin/profile*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('users.profile') }}"><i class="fa fa-user"></i> @lang("Profile")</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> @lang("Logout")</a>
                    </li>
                    @endauth
                </ul>
            </div>
        ...
        <script src="{{ assetv('js/backend.js') }}"></script>
        @show
    </body>
</html>